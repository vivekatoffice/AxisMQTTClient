...
function setFormEnabledState(enabled) {
  ...
  //document.getElementById("publishONButton").disabled = !enabled;
  //document.getElementById("publishOFFButton").disabled = !enabled;
...
function publishON() {
  ...
  client.send(message);
  //document.getElementById("publishOFFButton").disabled = true;
}
...
function publishOFF() {
    ...
    message.retained = retain;
    client.send(message);
    //document.getElementById("publishONButton").disabled = false;
  }
